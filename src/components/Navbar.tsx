...
> = {
  ...
  'phim-hai': { name: 'Hài Hước', icon: Smile, tagline: 'Vui nhộn, hóm hỉnh, giải trí', color: 'text-yellow-400 bg-yellow-500/10 border-yellow-500/30' },
  ...
  'phim-nhac': { name: 'Âm Nhạc', icon: Music, tagline: 'Giai điệu & nghệ thuật', color: 'text-rose-400 bg-rose-500/10 border-rose-500/30' },
